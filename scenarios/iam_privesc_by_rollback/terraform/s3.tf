...
locals {
  ...
  bucket_suffix = substr( replace(var.cgid, "/[^a-z0-9-.]/", "-"),1,60)
}
...
resource "aws_s3_bucket_object" "cardholder-data-primary" {
  ...
  source = "../assets/files/cardholder_data_primary.csv"
  tags = {
...
resource "aws_s3_bucket_object" "cardholder-data-secondary" {
  ...
  source = "../assets/files/cardholder_data_secondary.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
    Scenario = "${var.scenario-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-corporate" {
  ...
  source = "../assets/files/cardholders_corporate.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
    Scenario = "${var.scenario-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-primary2" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholder_data_primary.csv"
  source = "../assets/files/cardholder_data_primary2.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
    Scenario = "${var.scenario-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-secondary2" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholder_data_secondary2.csv"
  source = "../assets/files/cardholder_data_secondary.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-corporate2" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholders_corporate2.csv"
  source = "../assets/files/cardholders_corporate.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-primary3" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholder_data_primary.csv"
  source = "../assets/files/cardholder_data_primary3.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
    Scenario = "${var.scenario-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-secondary3" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholder_data_secondary3.csv"
  source = "../assets/files/cardholder_data_secondary.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
...
resource "aws_s3_bucket_object" "cardholder-data-corporate3" {
  bucket = "${aws_s3_bucket.cg-cardholder-data-bucket.id}"
  key = "cardholders_corporate3.csv"
  source = "../assets/files/cardholders_corporate.csv"
  tags = {
    Name = "cardholder-data-${var.cgid}"
    Stack = "${var.stack-name}"
